...
#   2）或传参: DATA_ID=llm/pubdatasets_gsm8k PRE_TRAINED_M=/path/to/Qwen3-0.6B/model.h5 bash task.sh
...
export DATA_ID="${DATA_ID:-llm/pubdatasets_gsm8k}"
# 其他可选: llm/pubdatasets_squad, llm/pubdatasets_nq, llm/pubdatasets_toolbench
