...
llm_path = "/home/common/plm/Qwen/Qwen3-0.6B"
...
print(ht.apply_chat_template(chat, tokenize=False, add_generation_prompt=True, enable_thinking=True))
ids = ht.apply_chat_template(chat, tokenize=True, add_generation_prompt=True, enable_thinking=True)
print(ids)
...
hm = transformers.Qwen3ForCausalLM.from_pretrained(llm_path)
hm.eval()
