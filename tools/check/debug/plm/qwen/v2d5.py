...
from transformer.PLM.QWen.v2d5.Decoder import Decoder as NMT
from utils.torch.comp import torch_inference_mode

import cnfg.plm.qwen.v2d5.base as cnfg
from cnfg.plm.qwen.v2d5.ihyp import *
from cnfg.vocab.plm.qwen.v2d5 import vocab_size

llm_path = "plm/Qwen2.5-0.5B-Instruct"
...
hm = transformers.Qwen2ForCausalLM.from_pretrained(llm_path)
hm.eval()
