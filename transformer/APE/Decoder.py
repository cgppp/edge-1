...
class DecoderLayer(DecoderLayerBase):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, act_drop=None, num_head=8, ahsize=None, **kwargs):
		...
		self.cross_attn_mt = ResCrossAttn(isize, hsize=_ahsize, num_head=num_head, dropout=attn_drop, norm_residual=self.cross_attn.norm_residual)
...
class Decoder(DecoderBase):
	...
	def decode(self, inpute, inputm, src_pad_mask, mt_pad_mask, beam_size=1, max_len=512, length_penalty=0.0, fill_pad=False, **kwargs):

		return self.beam_decode(inpute, inputm, src_pad_mask=src_pad_mask, mt_pad_mask=mt_pad_mask, beam_size=beam_size, max_len=max_len, length_penalty=length_penalty, fill_pad=fill_pad, **kwargs) if beam_size > 1 else self.greedy_decode(inpute, inputm, src_pad_mask=src_pad_mask, mt_pad_mask=mt_pad_mask, max_len=max_len, fill_pad=fill_pad, **kwargs)

	def greedy_decode(self, inpute, inputm, src_pad_mask=None, mt_pad_mask=None, max_len=512, fill_pad=False, sample=False, top_k=1, top_p=0.0, temp=1.0, **kwargs):
	...
	def beam_decode(self, inpute, inputm, src_pad_mask=None, mt_pad_mask=None, beam_size=8, max_len=512, length_penalty=0.0, return_all=False, clip_beam=clip_beam_with_lp, fill_pad=False, **kwargs):
