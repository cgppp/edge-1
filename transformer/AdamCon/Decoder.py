...
from modules.adamcon.layer import PositionwiseFF, ResCrossAttn, ResSelfAttn
...
class Decoder(DecoderBase):
	...
	def forward(self, inpute, inputo, src_pad_mask=None, **kwargs):
		...
		# all adamcon shall be bound to self.nets[0].self_attn.adamcon via utils.adamcon.bind_adamcon and reset after layers' propagation
		self.nets[0].self_attn.adamcon.reset()
