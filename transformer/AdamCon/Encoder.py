...
from modules.adamcon.layer import PositionwiseFF, ResSelfAttn
...
class Encoder(EncoderBase):
	...
	def forward(self, inputs, mask=None, **kwargs):
		...
		# all adamcon shall be bound to self.nets[0].attn.adamcon via utils.adamcon.bind_adamcon and reset after layers' propagation
		self.nets[0].attn.adamcon.reset()
