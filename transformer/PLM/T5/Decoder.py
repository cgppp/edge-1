...
class DecoderLayer(DecoderLayerBase):
	...
	def __init__(self, isize, fhsize=None, dropout=0.0, attn_drop=0.0, act_drop=None, num_head=8, ahsize=None, norm_residual=norm_residual_default, k_rel_pos=use_k_relative_position_decoder, max_bucket_distance=relative_position_max_bucket_distance_decoder, k_rel_pos_cattn=use_k_relative_position_cattn, max_bucket_distance_cattn=relative_position_max_bucket_distance_cattn, model_name="decoder", **kwargs):
		...
		self.cross_attn = ResCrossAttn(isize, hsize=_ahsize, num_head=num_head, dropout=attn_drop, norm_residual=norm_residual, k_rel_pos=k_rel_pos_cattn, max_bucket_distance=max_bucket_distance_cattn)
	...
	def load_plm(self, plm_parameters, model_name=None, layer_idx=None, **kwargs):
		...
		with torch_no_grad():
			...
			align_linear_bias(self.cross_attn.net.query_adaptor, plm_parameters, _bias_key)
			...
			align_linear_bias(self.cross_attn.net.kv_adaptor, plm_parameters, _bias_key)
			...
			align_linear_bias(self.cross_attn.net.outer, plm_parameters, _bias_key)
...
class Decoder(DecoderBase):
	...
	def __init__(self, isize, nwd, num_layer, fhsize=None, dropout=0.0, attn_drop=0.0, act_drop=None, emb_w=None, num_head=8, xseql=cache_len_default, ahsize=None, norm_output=True, bindemb=True, forbidden_index=None, share_layer=False, disable_pemb=disable_std_pemb_decoder, remove_classifier_bias=remove_classifier_bias, model_name="decoder", **kwargs):
		...
		super(Decoder, self).__init__(isize, nwd, num_layer, fhsize=_fhsize, dropout=dropout, attn_drop=attn_drop, act_drop=act_drop, emb_w=emb_w, num_head=num_head, xseql=xseql, ahsize=_ahsize, norm_output=norm_output, bindemb=bindemb, forbidden_index=forbidden_index, share_layer=True, disable_pemb=disable_pemb, **kwargs)
