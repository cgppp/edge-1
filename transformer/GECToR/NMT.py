...
class NMT(NMTBase):
	...
	def decode(self, inpute, beam_size=1, max_len=None, length_penalty=0.0, op_keep_bias=0.0, pad_id=pad_id, mask_id=mask_id, edit_pad_id=edit_pad_id, blank_id=blank_id, delete_id=delete_id, **kwargs):
