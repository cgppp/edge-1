...
class PositionwiseFF(PositionwiseFFBase):
	...
	def __init__(self, isize, ngroup=None, hsize=None, dropout=0.0, act_drop=None, ntask=None, custom_act=use_adv_act_default, enable_bias=enable_prev_ln_bias_default, **kwargs):
...
class SelfAttn(SelfAttnBase):
	...
	def __init__(self, isize, hsize=None, osize=None, ngroup=None, num_head=8, dropout=0.0, enable_bias=enable_prev_ln_bias_default, enable_proj_bias=enable_proj_bias_default, **kwargs):

		self.ngroup, self.osize = ngroup, parse_none(osize, isize)
		super(SelfAttn, self).__init__(isize, hsize=parse_none(hsize, isize) * ngroup, osize=self.osize, num_head=num_head * ngroup, dropout=dropout, enable_bias=enable_bias, enable_proj_bias=enable_proj_bias, **kwargs)
...
class CrossAttn(CrossAttnBase):
	...
	def __init__(self, isize, hsize=None, osize=None, ngroup=None, num_head=8, dropout=0.0, k_isize=None, enable_bias=enable_prev_ln_bias_default, enable_proj_bias=enable_proj_bias_default, **kwargs):

		self.ngroup, self.osize = ngroup, parse_none(osize, isize)
		super(CrossAttn, self).__init__(isize, parse_none(hsize, isize) * ngroup, self.osize, num_head=num_head * ngroup, dropout=dropout, k_isize=k_isize, enable_bias=enable_bias, enable_proj_bias=enable_proj_bias, **kwargs)
