...
class SelfAttn(SelfAttnBase):
	...
	def forward(self, iQ, mask=None, states=None, **kwargs):
		...
		# (bsize, nheads // kv_nheads, kv_nheads, nquery, adim) * (bsize, 1, kv_nheads, adim, seql) = > (bsize, nheads // kv_nheads, kv_nheads, nquery, seql)
		...
		# (bsize, nheads // kv_nheads, kv_nheads, nquery, seql) * (bsize, 1, kv_nheads, seql, adim) = > (bsize, nheads // kv_nheads, kv_nheads, nquery, adim)
