...
class SelfAttn(SelfAttnBase):
	...
	def __init__(self, isize, hsize=None, osize=None, num_head=8, dropout=0.0, enable_bias=enable_prev_ln_bias_default, custom_act=use_adv_act_default, **kwargs):
	...
	def forward(self, iQ, mask=None, states=None, **kwargs):
		...
		real_iQ, _h_real_iK, seql, sid = _real_iQ, None, nquery, 0
