...
setup(name="lgates_cuda", ext_modules=[cpp_extension.CUDAExtension("lgates_cuda", ["utils/cpp/hardlimit.h", "modules/cpp/hplstm/lgates_cuda.cpp", "modules/cpp/hplstm/lgates_cuda_kernel.cu"], extra_compile_args={"cxx": extra_compile_args, "nvcc": extra_cuda_compile_args})], cmdclass={"build_ext": cpp_extension.BuildExtension})
setup(name="ml2mvavgs_cuda", ext_modules=[cpp_extension.CUDAExtension("ml2mvavgs_cuda", ["utils/cpp/hardlimit.h", "modules/cpp/hplstm/ml2mvavgs_cuda.cpp", "modules/cpp/hplstm/ml2mvavgs_cuda_kernel.cu"], extra_compile_args={"cxx": extra_compile_args, "nvcc": extra_cuda_compile_args})], cmdclass={"build_ext": cpp_extension.BuildExtension})
