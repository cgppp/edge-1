...
# 用法：
#   bash task-eval.sh
#   TASK=squad PRED_FILE=... GOLD_FILE=... DETAIL_FILE=... bash task-eval.sh
#
# 任务名 TASK 示例：squad trivia nq_v1 nq_std all_nq medmcqa pubmedqa mmlu gsm8k math tool
...
TASK="${TASK:-squad}"
PRED_FILE="${PRED_FILE:-expm/llm/pubdatasets_squad_closed/std/base/pred_last.txt}"
GOLD_FILE="${GOLD_FILE:-cache/llm/pubdatasets_squad_closed/tgt.dev.txt}"
DETAIL_FILE="${DETAIL_FILE:-expm/llm/pubdatasets_squad_closed/std/base/eval_detail.jsonl}"
