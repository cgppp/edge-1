...
nhead = max(1, isize // 64)# 14 for 0.5B, 12 for 1.5B, 16 for 3B, 28 for 7B, 40 for 14B
attn_hsize = isize
kv_nhead = 2# 2 for 0.5/1.5/3B, 4 for 7B, 8 for 14B

nlayer = 24# 24 for 0.5B, 28 for 1.5/7B, 36 for 3B, 48 for 14B
