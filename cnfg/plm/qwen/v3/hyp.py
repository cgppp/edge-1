...
add_attn_qkv_bias = False# False for 0.6/1.7/4/8/14B
add_self_attn_qknorm = True
sliding_window = -1# use_sliding_window is False for 0.6/1.7/4/8/14B
...
use_glu_ffn = "SwiGLU"#"Swish" for 0.6/1.7/4/8/14B

# choices: "v1", "v2"
computation_order = "v2"

# default cached sequence length (for positional embedding, etc.)
cache_len_default = 4096# 40960 for 0.6B, reduced for subsequent mask cache
