...
add_self_attn_postnorm = True
add_pffn_postnorm = True
sliding_window = 512# 512 for 1B, -1 to disable
sliding_window_layerid_pattern = 6
...
use_glu_ffn = "GETanhGLU"#"GETanhGLU" for 1B

# choices: "v1", "v2"
computation_order = "v2"

# default cached sequence length (for positional embedding, etc.)
cache_len_default = 4096# 32768 for 1B, reduced for subsequent mask cache
...
use_rope = True
rope_linear_scaling = 1.0# 1.0 for 1B
