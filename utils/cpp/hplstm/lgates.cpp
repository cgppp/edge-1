...
template <typename scalar_t> inline void omp_lgate_forward_(torch::TensorAccessor<scalar_t, 4> fgate, torch::TensorAccessor<scalar_t, 4> igh, torch::TensorAccessor<scalar_t, 3> init_cell, torch::TensorAccessor<scalar_t, 4> cell, int bsize, int seqlen, int nhead, int isize) {
...
template <typename scalar_t> inline void omp_lgate_backward_(torch::TensorAccessor<scalar_t, 4> grad_cell, torch::TensorAccessor<scalar_t, 4> cell, torch::TensorAccessor<scalar_t, 4> fgate, torch::TensorAccessor<scalar_t, 3> init_cell, torch::TensorAccessor<scalar_t, 4> grad_fgate, torch::TensorAccessor<scalar_t, 4> grad_igh, torch::TensorAccessor<scalar_t, 3> grad_prev_cell, int bsize, int seqlen, int nhead, int isize) {
...
template <typename scalar_t> at::Tensor lgate_forward(torch::Tensor fgate, torch::Tensor igh, torch::Tensor init_cell, torch::Tensor cell, int64_t bsize, int64_t seqlen, int64_t nhead, int64_t isize) {
	...
	omp_lgate_forward_<scalar_t>(fgate.accessor<scalar_t, 4>(), igh.accessor<scalar_t, 4>(), init_cell.accessor<scalar_t, 3>(), cell.accessor<scalar_t, 4>(), (int)bsize, (int)seqlen, (int)nhead, (int)isize);
...
template <typename scalar_t> std::vector<torch::Tensor> lgate_backward(torch::Tensor grad_cell, torch::Tensor cell, torch::Tensor fgate, torch::Tensor init_cell, torch::Tensor grad_fgate, torch::Tensor grad_igh, torch::Tensor grad_prev_cell, int64_t bsize, int64_t seqlen, int64_t nhead, int64_t isize) {
	...
	omp_lgate_backward_<scalar_t>(grad_cell.accessor<scalar_t, 4>(), cell.accessor<scalar_t, 4>(), fgate.accessor<scalar_t, 4>(), init_cell.accessor<scalar_t, 3>(), grad_fgate.accessor<scalar_t, 4>(), grad_igh.accessor<scalar_t, 4>(), grad_prev_cell.accessor<scalar_t, 3>(), (int)bsize, (int)seqlen, (int)nhead, (int)isize);
