...
setup(name="clmvavgis_cpp", ext_modules=[cpp_extension.CppExtension("clmvavgis_cpp", ["utils/cpp/hplstm/clmvavgis.cpp"], extra_compile_args=extra_compile_args)], cmdclass={"build_ext": cpp_extension.BuildExtension})
setup(name="ml2mvavgis_cuda", ext_modules=[cpp_extension.CUDAExtension("ml2mvavgis_cuda", ["utils/cpp/hplstm/ml2mvavgs_cuda.cpp", "utils/cpp/hplstm/ml2mvavgis_cuda_kernel.cu"], extra_compile_args={"cxx": extra_compile_args, "nvcc": extra_cuda_compile_args})], cmdclass={"build_ext": cpp_extension.BuildExtension})
