...
def get_batch(seq_batch, seq_kb, seq_edt, seq_o, p=0.15, init_normal_token_id=init_normal_token_id, keep_id=keep_id, blank_id=blank_id, edit_mask_id=edit_mask_id, plm_mask_id=plm_mask_id):
